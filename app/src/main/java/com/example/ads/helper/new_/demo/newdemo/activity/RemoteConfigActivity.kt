...
class RemoteConfigActivity : BaseBindingActivity<ActivityRemoteConfigBinding>() {
    ...
    override fun initView() {
        ...
        with(mBinding) {
            val screenItems = listOf(MorePlanScreenType.FOUR_PLAN_SCREEN.value, MorePlanScreenType.SIX_BOX_SCREEN.value,MorePlanScreenType.WEEKLY_SCREEN.value ,MorePlanScreenType.TWO_PLAN_SCREEN.value)
        ...
        mActivity.setOfflineRemoteConfig {
            with(mActivity.remoteConfigModel) {
                ...
                with(mBinding) {
                    ...
                    etSubscriptionCloseTiming.text = vasuSubscriptionConfig.subscriptionCloseIconShowTime.toString().toEditable
                ...
                btnNext -> {
                    val lDataModel = AppRemoteConfigModel(
                        ...
                        vasuSubscriptionConfig = VasuSubscriptionConfigModel(
                            ...
                            subscriptionCloseIconShowTime = etSubscriptionCloseTiming.text?.toString()?.trim()?.toLongOrNull() ?: 3000L,
