...
public final class ActivityMainBinding implements ViewBinding {
  ...
  @NonNull
  public final Button showBannerAds;
  ...
  @NonNull
  public final Button showSubscriptionScreen;
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull SwitchCompat adsSwitch,
      ...
      @NonNull Button showBannerAds, @NonNull Button showCustomNativeAds,
      ...
      @NonNull Button showRunTimePermission, @NonNull Button showSubscriptionScreen) {
    this.rootView = rootView;
    this.adsSwitch = adsSwitch;
    this.layoutHeader = layoutHeader;
    this.openAdsSwitch = openAdsSwitch;
    this.showBannerAds = showBannerAds;
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.show_banner_ads;
      Button showBannerAds = ViewBindings.findChildViewById(rootView, id);
      if (showBannerAds == null) {
        break missingId;
      }
      ...
      id = R.id.show_subscription_screen;
      Button showSubscriptionScreen = ViewBindings.findChildViewById(rootView, id);
      if (showSubscriptionScreen == null) {
        break missingId;
      }

      return new ActivityMainBinding((ConstraintLayout) rootView, adsSwitch, binding_layoutHeader,
          openAdsSwitch, showBannerAds, showCustomNativeAds, showDialogs, showFullScreenNativeAd,
          showInterstitialAds, showNativeAds, showRewardInterstitialAds, showRewardVideoAds,
          showRunTimePermission, showSubscriptionScreen);
    }
