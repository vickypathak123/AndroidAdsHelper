...
import com.example.app.ads.helper.utils.is_need_to_load_multiple_rewarded_interstitial_ad_request
...
//            onAdLoaded.invoke()
    ...
    private fun isRewardedInterstitialAdEnable(): Boolean = isAppNotPurchased && is_enable_rewarded_interstitial_ad_from_remote_config
