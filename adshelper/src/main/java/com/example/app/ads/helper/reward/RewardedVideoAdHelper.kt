...
import com.example.app.ads.helper.utils.is_need_to_load_multiple_rewarded_video_ad_request
...
//            onAdLoaded.invoke()
    ...
    private fun isRewardedVideoAdEnable(): Boolean = isAppNotPurchased && is_enable_rewarded_video_ad_from_remote_config
