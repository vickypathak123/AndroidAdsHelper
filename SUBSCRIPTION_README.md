...
- Add initialization of your remote config json & RevenueCat SDK, for example:
        ...
        class AppApplication : AppOpenApplication() {
            ...
            override fun onCreate() {
                super.onCreate()
                    ...
                /**
                 * initialization of RevenueCat SDK.
                 * Call this if your app use the RevenueCat SDK.
                 *
                 * @param fContext it's refers to your application, activity or fragment context.
                 * @param revenueCatID it's refers to your project's RevenueCat Public API Key.
                 */
