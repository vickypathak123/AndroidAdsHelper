...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final AkspermissionLibraryAccessors laccForAkspermissionLibraryAccessors = new AkspermissionLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>colorslider</b> with <b>com.github.naz013:ColorSlider</b> coordinates and
     * with version reference <b>colorslider</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getColorslider() {
        return create("colorslider");
    }

    /**
     * Dependency provider for <b>dotsindicator</b> with <b>com.github.zhpanvip:viewpagerindicator</b> coordinates and
    ...
    /**
     * Dependency provider for <b>revenuecat</b> with <b>com.revenuecat.purchases:purchases</b> coordinates and
     * with version reference <b>revenuecat</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getRevenuecat() {
        return create("revenuecat");
    }

    /**
     * Group of libraries at <b>akspermission</b>
     */
    public AkspermissionLibraryAccessors getAkspermission() {
        return laccForAkspermissionLibraryAccessors;
    }
    ...
    public static class AkspermissionLibraryAccessors extends SubDependencyFactory {

        public AkspermissionLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>android</b> with <b>com.github.AkshayHarsoda:AksPermission-Android</b> coordinates and
         * with version reference <b>akspermissionAndroid</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAndroid() {
            return create("akspermission.android");
        }
    ...
    public static class AndroidLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>android.billing</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getBilling() {
            return create("android.billing");
        }
    ...
    public static class GooglePlayServicesLibraryAccessors extends SubDependencyFactory {
        ...
        public Provider<MinimalExternalModuleDependency> getAds() {
            return create("google.play.services.ads");
        }
    ...
    public static class IntuitLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>ssp</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class LottieLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>animation</b> with <b>com.airbnb.android:lottie</b> coordinates and
         * with version reference <b>lottie</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAnimation() {
            return create("lottie.animation");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>akspermissionAndroid</b> with value <b>v1.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAkspermissionAndroid() { return getVersion("akspermissionAndroid"); }
        ...
        /**
         * Version alias <b>colorslider</b> with value <b>2.0.6</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getColorslider() { return getVersion("colorslider"); }
        ...
        /**
         * Version alias <b>dotsindicator</b> with value <b>1.2.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>googleGson</b> with value <b>2.10.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>revenuecat</b> with value <b>8.4.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getRevenuecat() { return getVersion("revenuecat"); }

        /**
         * Version alias <b>sdp</b> with value <b>1.1.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>ssp</b> with value <b>1.1.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class AndroidVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>android.billing</b> with value <b>7.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getBilling() { return getVersion("android.billing"); }
